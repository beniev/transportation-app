"""
Base Django settings for transportation app.
"""
...
REST_AUTH['REGISTER_SERIALIZER'] = 'apps.accounts.serializers.CustomRegisterSerializer'
...
GCS_CREDENTIALS_FILE = config('GCS_CREDENTIALS_FILE', default='')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@movers-app.com')

# Payment Gateway (Tranzila)
TRANZILA_TERMINAL = config('TRANZILA_TERMINAL', default='')
TRANZILA_PASSWORD = config('TRANZILA_PASSWORD', default='')
